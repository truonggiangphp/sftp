...
{    
    ...
    {
        $test = Sftp::isFile($server, $user, $password, $remote_file, $port);
        $this->assertTrue($test);
    }
    ...
    {
        $test = Sftp::uploadDir($server, $user, $password, $local_path, $remote_path, $port);
        $this->assertTrue($test);
    }
    ...
    {
        $test = Sftp::downloadDir($server, $user, $password, $remote_dir, $local_dir, $port);
        $this->assertTrue($test);
    }
